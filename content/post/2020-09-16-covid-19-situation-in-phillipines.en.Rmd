...
Philippines is currently contemplating easing its restrictions. Initially, there was a call from senior doctors to imposing a stricter lockdown in Manila- a much needed "timeout" for the overwhelming hospitals. We now look at its current state of capaci 
...
```{r}
plotly::subplot(hos3_ply, hos1_ply)
```
...
Lastly, looking at its hospital capacity and availability of equipment exclusively for Covid-19 patients (data source: @DOH). Also considering the number of new cases are slowly decreasing it may not be a bad idea to start gradually easing the restrictions. 
