...
```{r}
plotly::subplot(hos3_ply, hos1_ply, margin = 0.09)
```
...
In terms of hospital capacity and availability of equipment exclusively for Covid-19 patients (from @DOH). 

Therefore, considering the number of new cases are slowly decreasing it may not be a bad idea to start gradually easing the restrictions. 
